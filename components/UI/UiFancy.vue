<template>
    <span class="fancy-wrapper">
        ...
        <div v-if="icon" :class="[iconSize, iconCenter && 'left-1/2 -translate-x-1/2']" class="font-emoji icon py-4 absolute top-1/2 transform -translate-y-1/2 text-transparent bg-clip-text bg-primary-200 opacity-10">
            {{ icon }}
        </div>
